...
import { Avatar, Divider, List, ListItem, ListItemAvatar, ListItemText, Box, Grid, SxProps, Skeleton, FormControl, MenuItem, styled, Menu } from '@mui/material'
...
export default function BrandsPage() {
    ...
    function handleDeleteBrand() {
        instance.delete(`brands/${selectedBrand?.id}`).then(res => {
            if (res?.data?.success) {
    ...
    return (
        <Box sx={{ width: '1200px', minHeight: 829, display: "block", margin: "32px auto" }}>
                    ...
                    <>
                                            ...
                                            ? all__brands?.data?.brands?.map((brand, index: any) =>
                                                <>
                                                    ...
                                                    >
                                                        ...
                                                        <ListItemText sx={{ ...widthControl, ...itemAsLink, justifyContent: 'center' }}
                        ...
                        }
                        {
                            <Grid spacing={2} container sx={{ width: '100%', margin: "0 auto", padding: "17px 0 32px 0" }}>
                                ...
                                >
                                    <SimpleTypography
                                        text={`Показаны ${all__brands?.data?.pagination?.current + 1}–${all__brands?.data?.pagination?.limit} из`}
