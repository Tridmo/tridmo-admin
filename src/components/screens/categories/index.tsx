...
import { getCategories, getInteriorCategories, getModelCategories, selectCategories } from '../../../data/categories'
...
export default function CategoriesPage() {
    ...
    const all__categories_status = useSelector((state: any) => state?.categories?.status)
                                            ...
                                            categories &&
                                                ...
                                                ? categories?.map((category, index: any) =>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <SimpleTypography
                                                                text={category?.children && category?.children[0] != null ? category?.children?.length : 0}
                                                                sx={{
                                                                    fontSize: '14px',
                                                                    fontWeight: 400,
                                                                    lineHeight: '26px',
