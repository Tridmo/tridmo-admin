...
import { selectAllTags, selectAllTags_status } from '../../../data/get_all_tags'
...
export default function TagsPage() {
  ...
  // useMemo(() => {
  //   setTagsCount(tags?.pagination?.data_count || 0)
  // }, [tags, tags_status])
                  ...
                  tags && tags?.tags?.length != 0
                    ? tags?.tags?.map((tag, index: any) =>
                      ...
                      >
                        ...
                        >
                          <Link style={linkStyle} href={`/models/${tag?.model?.slug}`}></Link>
                          <Box
                            sx={{
                              ...modelImageWrapperSx,
                              '&:hover:after': {
                              ...
                              '&::after': {
                                backgroundImage: tag?.model?.cover ? `url(${IMAGES_BASE_URL}/${tag?.model?.cover})` : `url('/img/cube.png')`,
                                ...imageViewerStyle,
                              }
                            }}
                          >
                            <Image
                              src={tag?.model?.cover ? `${IMAGES_BASE_URL}/${tag?.model?.cover}` : `/img/cube.png`}
                              alt='image'
                              width={36}
                              height={36}
                              style={modelImageSx}
                        ...
                        >
                          <Link style={linkStyle} href={`/interiors/${tag?.interior?.slug}`}></Link>
                          <Box
                            sx={{
                              ...modelImageWrapperSx,
                              '&:hover:after': {
                              ...
                              '&::after': {
                                backgroundImage: tag?.interior?.cover ? `url(${IMAGES_BASE_URL}/${tag?.interior?.cover})` : `url(/img/cube.jpg)`,
                                ...imageViewerStyle
                              }
                            }}
                          >
                            <Image
                              src={tag?.interior?.cover ? `${IMAGES_BASE_URL}/${tag?.interior?.cover}` : `/img/cube.jpg`}
                              alt='image'
                              width={36}
                              height={36}
                              style={modelImageSx}
                          ...
                          <ListItemText className='brand_name' sx={{ marginLeft: '24px', }} >
                            ...
                            />
                            {/* <SimpleTypography
                              text={`@${tag?.interior?.author?.username}`}
                              sx={{
                                fontSize: '12px',
                                fontWeight: 400,
                                lineHeight: '24px',
                        ...
                        >
                          <Link style={linkStyle} href={`/users/${tag?.interior?.author?.username}`}></Link>
                          <Box
                            sx={{
                              ...modelImageWrapperSx,
                              '&:hover:after': {
                              ...
                              '&::after': {
                                backgroundImage: tag?.interior?.author?.image_src ? `url(${IMAGES_BASE_URL}/${tag?.interior?.author?.image_src})` : `url(/img/avatar.png)`,
                                ...imageViewerStyle
                              }
                            }}
                          >
                            <Image
                              src={tag?.interior?.author?.image_src ? `${IMAGES_BASE_URL}/${tag?.interior?.author?.image_src}` : `/img/avatar.png`}
                              alt='image'
                              width={36}
                              height={36}
                              style={modelImageSx}
                          ...
                          <ListItemText className='brand_name' sx={{ marginLeft: '24px', }} >
                            <SimpleTypography
                              className='ellipsis__title'
                              text={tag?.interior?.author?.full_name}
                              sx={{
                                fontSize: '16px',
                                fontWeight: 400,
                                lineHeight: '26px',
                        ...
                        >
                          <SimpleTypography
                            text={formatDate(tag?.created_at, true)}
                            sx={{
                              fontSize: '14px',
                              fontWeight: 400,
                              lineHeight: '26px',
          ...
          <Grid container sx={{ width: '100%', margin: "0 auto", padding: "17px 0 32px 0" }}>
            ...
            >
              <Pagination
                ...
                count={tags?.pagination?.pages}
                page={parseInt(tags?.pagination?.current) + 1}
              />
            </Grid>
          </Grid>
        </>
