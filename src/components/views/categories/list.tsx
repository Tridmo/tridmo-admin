...
import { ConfirmContextProps, resetConfirmData, resetConfirmProps, setCategoryFormState, setConfirmProps, setConfirmState, setOpenModal } from '../../../data/modal_checker'
...
export default function CategoriesList() {
  ...
  function handleOpenEditModal() {
    dispatch(setCategoryFormState({ open: true, editing: true, category: selectedMenuCategory }))
    dispatch(setOpenModal(true))
    handleClose()
  }
