...
import { getCategories, getModelCategories, selectCategories, selectInteriorCategories, selectModelCategories } from '../../../../data/categories';
...
export function AddCategoryForm() {
    ...
    const [selectedType, setSelectedType] = useState<'model' | 'interior' | string>('model')
