...
import { setMaterialFormState, setOpenModal, setStyleFormState } from "../../../data/modal_checker";
...
export function MaterialForm({ editing = false, material }: { editing?: boolean, material?: any }) {
  ...
  const initialData: DataInterface = {
    name: editing && material?.name ? material?.name : '',
    submit: null
  }
  ...
  return (
    ...
    >
      <Box sx={{ marginBottom: '40px' }}>
        <SimpleTypography
          text={editing ? "Редактировать материал" : "Новый материал"}
          sx={{
            fontSize: '30px',
            fontWeight: '500',
            lineHeight: '36px',
